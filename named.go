...
// QueryRow executes a named statement against the database.  Because orm cannot
// create a *sql.Row with an error condition pre-set for binding errors, orm
// returns a *orm.Row instead.
// Any named placeholder parameters are replaced with fields from arg.
...
// DEPRECATED: use orm.Named` instead of this, it may be removed in future.
...
// provided Ext (orm.Tx, orm.Db).  It works with both structs and with
